...
- in general: emigration affects voting behaviour and electoral outcomes; as a global phenomena, over different time periods
	...
	- 2022 lim: emigrants from Central and Eastern Europe are disproportionately more from politically progressive populations, and the level of support for far-right parties is higher in regions with large levels of emigration → Lim focuses on the change of the electorate (emigration leads to less young, cosmopolitan electorate). however, Lim does not look into how emigration affects the people left behind (2022 lim, p. 46), which I intend on looking at
	- through remittances in mexico (?) (2014 pfutze)
	- 2017 karadja in 19th century Sweden
	- emigration causes a decrease in political interest
		- 2008 Goodman / Bravo, Jorge, 2007: citizens in high migration towns become less engaged in their formal political system → less civic engagement
		- 2019 Sellars: Less political mobilisation and collective action
		- 2022 Kyriazi
		- 2017 Anelli: Less political change
		- 2022 Peters: emigration produces quiescent populations; also takes authoritarian states into account
		- foundations of european politics / Keleman: Domestic opposition is weakened
		- 2022 Lim: Loss in political actors
		- 2021 Lockhart: emigration lowers the demand for democratic reforms
	- maybe also: 2011 docquier, p. 5
...
- @dancygierEmigrationRadicalRight2022 and others (2022 Lim, …) uncover links between emigration and rise in populist and radical parties
- However, there is a point to be made that non-extreme parties, e.g. a mainstream opposition party, may also benefit from emigration
	- emigration is not politicised, and if it is, then it is used to critique the incumbent government and status quo parties (mercator 2020)
	- Voters receive remittances which realigns their party preferences closer to their personal ideological preferences (2012 pfutze), which does not have to be an extreme party
	- No extreme party on the ballot.
	- there are also specific cases, where an extreme party does not benefit from emigration is 2023 Schütze: regional out-migration does not lead to a higher voting preference for the AfD. however, this paper only looks at internal east-west German migration, which does not take the EU’s FoM into account

- grievances and depression
	- 2018 Nikolova: higher life satisfaction and budget easing through remittances, but more depression and stress → how does this influence the causal mechanism? can i assume that service cuts cause more/different grievances, that can be directed more at the government, unlike family-caused grievances?
...
- effects of emigration in CEE
	...
	- 2022 lim: bases research in the change of the electorate, only touching on how emigration changes voting behaviour of the people left behind
