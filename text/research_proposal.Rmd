...
This is the updated causal chain of events, based on @dancygierEmigrationRadicalRight2022 (refer to chain of events further up)
...
I will measure the effect of service cuts on a subnational level. Specifically NUTS3 level, data permitting. I do this for the following two reasons. First, measuring subnational regions instead of countries will increase sample size und thus provide more accurate results. Second, regions have different levels of emigration (see map of average emigration rate over last 20 years), allowing to measure the effects of different emigration levels.
