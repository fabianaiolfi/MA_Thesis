...
I assume that population decline has a negative effect on the number of schools, the number of hospitals and the number of “third places”^[“Third places” are local "informal public gathering places" that foster community building [@oldenburgGreatGoodPlace1999 16], e.g., cafés, bars and restaurants.] I argue that a decrease in the number of these institutions causes grievances amongst the remaining population.
...
Schools and hospital closings are services made available by the state. In contrast, “third places” are supplied by private sector. Their closure can erode a communal sense of belonging and push people towards populist parties [@boletDrinkingAloneLocal2021 1653].
