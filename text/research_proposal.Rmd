...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../documentation/01_average_net_migration_map.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../documentation/international_emigration_eu_accession.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../documentation/migr_and_switching.png}
