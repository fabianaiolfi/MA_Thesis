...
- CEE countries show high levels of emigration (numbers, source)
	...
	- Potential exploration: is there a correlation between end of Freedom of Movement-transitional period and increase in external migration? → if yes, this would help this thesis’ case of the EU’s effect on emigration in CEE → see job vacancy stats https://ec.europa.eu/eurostat/web/labour-market/database
...
- 2012 Pfutze: receipt of remittances, by weakening the importance of redistributional policies, realigns party preferences in favor of ideological preferences (see also 2014 Pfutze for more on remittances); looks at Mexico, are the same results to be expected in the EU?
- 2017 Barsbai: significant and robust negative effect of emigration to the West on the share of votes for the Communist Party in the Moldovan elections of 2009–2010 → too specific a case, perhaps cannot be applied to other CEE states? also not in EU;
- 2022 Lim
...
→ Lim makes assumptions of how voters are affected by emigration; does not explain why → I will fill this research gap; Lim focuses on the change of the electorate (emigration leads to less young, cosmopolitan electorate). Lim does not look into what the effect emigration has on the people left behind, i intend to fill this research gap

- 2017 Gidron: one of the key empirical questions we address is whether people who feel ‘left behind’ are more inclined than others to support populist parties. → but: “left behind” does not explicitly refer to emigration

- 2023 Schütze: key finding of the cross-sectional analysis is that regional out-migration is a condition that moderates the relationship between civic participation and the election of the AfD; regional out-migration does not lead to a higher voting preference for the AfD → looks at internal east-west German migration, not taking effect of EU into account
...
- unclear how service cuts affect voting behaviour
