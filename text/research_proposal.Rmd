...
- Does emigration change the voting behaviour of the people left behind?
- Theory tells us that emigration makes remaining voters unhappy (source?) and that unhappy voters cast a ballot against the incumbent (1992 Bowler, p. 489)
- Thus, a region with a high level of emigration should show a high level of anti-incumbent voting
- A brief analysis shows that this is sometimes the case in Romania, Bulgaria and Poland, but not in Croatia 
	- show results table
- 
...
This thesis will ask the following research question: Why does international emigration from CEE EU member states have a varying impact on the incumbent’s vote share?
