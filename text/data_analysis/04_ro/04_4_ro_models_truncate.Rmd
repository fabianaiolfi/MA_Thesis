...
Model results using truncated data are shows in Table x and x. The models in Table x use ratios as independent variables, models in Table x use numbers of institutions.

None of the truncated models show particularly promising results, apart model 1 when using actual numbers of institutions (see Table x). As with the non-truncated data, the number of schools and incumbent change in vote share are positively associated, with a decrease in schools going hand in hand with a decrease in incumbent vote share. All other coefficients from all other models using truncated data do not display statistically significant results. Also as with the non-truncated data, the control variable for emigration displays highly significant and strong effects, with an increase in emigration being associated with a decrease in incubment vote share.