...
The following plots do not show a consistent trends across all regions in Romania. A possible next step could be to categorise NUTS3 regions, e.g., into urban and rural regions, or regions that border neighboring countries, in an attempt to find groups with similar trends.
