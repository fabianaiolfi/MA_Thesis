...
Table 8 uses different independent variables compared to Table 7. Instead of using the ratio in an election year, I calculate the average ratio _change_ between two national parliamentary elections. As in Table 7, no independent variables are statistically significant.
