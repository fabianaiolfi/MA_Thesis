...
In Table 8, Models 1 through 4 differ to the models in Table 7 in the following aspect. Instead of using the ratio in an election year as the independent variable, I calculate the average ratio change between two national parliamentary elections. As in Table 7, no independent variables are statistically significant.
...
I add interaction terms between average change in ratio and average emigration. Here both the ratio of children per school and people per hospital are statistically significant and have negative coefficients. This indicates that more children per school and more people per hospital is associated with a decrease in incumbent vote share, dependent on the level of emigration.
