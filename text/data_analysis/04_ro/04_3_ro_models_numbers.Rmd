...
Table 11 uses different independent variables compared to Table 10. Instead of using the ratio in an election year, I calculate the average ratio _change_ between two national parliamentary elections. No independent variables are statistically significant.
