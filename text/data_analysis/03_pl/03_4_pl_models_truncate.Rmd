...
Model results using truncated data are shows in Table 7 and 8. The models in Table 7 use ratios as independent variables, models in Table 8 use numbers of institutions.
