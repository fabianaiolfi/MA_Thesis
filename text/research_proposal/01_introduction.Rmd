...
Does a country’s accession to the EU, and with it gaining access to the EU’s Freedom of Movement (FoM), have an effect on emigration rates? Figure \ref{fig:migr_accession_bar} displays a visualisation of a selection of countries that provided data on international emigration before and after the country’s accession. The vertical blue line represents when the country joined the EU. The time span covers, when data are available, ten years before and after accession.
