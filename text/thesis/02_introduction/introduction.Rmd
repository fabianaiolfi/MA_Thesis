...
<!-- Thesis Setup -->
This thesis is set up as follows. I begin with a literature review, looking into existing findings and theory behind the effects of emigration on voting behaviour. Next, following @dancygierEmigrationRadicalRight2022’s approach, I put forward hypotheses that posit an association between emigration induced service cuts and incumbent support. The service cuts are school closures, hospital closures and third places closures, e.g., bars and cafés. Based on the theory, I expect service cuts to reduce incumbent support.

In order to test the hypotheses, three assumptions must hold. 
...
- preliminary analysis: romania passes all “tests”, poland fails association between emigration and incumbent vote share, and is thus discarded from further analysis
