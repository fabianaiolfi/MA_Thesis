...
<!-- Intro -->
In the preliminary analysis, I establish a negative correlation between emigration and the change in incumbent vote share in Romania. Building upon this  finding, I develop two model specifications to test the hypotheses that service cuts decrease incumbent support. I choose this approach as it provides a more comprehensive and robust exploration of how service cuts and emigration may individually and interctively affect incumbnet vote share.
...
The subscript n symbolises a Romanian NUTS3 region and subscript y indicates an election year. The operationalisation of Emigration Rate and Service Cuts are described in X (TO DO). ε denotes the error term.
