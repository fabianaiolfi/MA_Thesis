...
Gaining EU membership grants member states access to the EU’s Freedom of Movement (FoM), facilitating migration between member states. Thus we can assume that becoming a member will result in higher levels of emigration from CEE EU member states. I examine this assumption in two steps. In a first step, I plot external emigration from Poland and Romania over time. If the assumption holds, we should observe an increase in emigration rates after a country’s accession. Figure X displays each country’s emigration rate over time, with the vertical dashed line marking the year of accession to EU membership. In both Poland and Romania we can observe a constant emigration rate up until accession. Once a country joins the EU, emigration rates pick up. However, the increase is lagged by two years in Poland and four years in Romania. The two countries also display different developments of emigration after the increase. Poland’s emigration rate decreases constantly after a peak is reached in 2006, with another small increase around 2013 and 2014. On the other hand, Romania displays a constant increase in emigration after 2010. These two distinctive developments hint at other factors influencing emigration rates along with access to FoM.

In a second step, I perform a Chow-Test [@chowTestsEqualitySets1960] for each NUTS region in Poland and Romania to examine if EU accession creates a break in the rate of emigration over time. A country’s year of accession is set as the break point. The Chow-Test returns a p-value, with which we can determine if the emigration rate displays a significant difference before and after accession.


The results show that, apart from the Czech Republic, EU accession does create a break in the time series with conventional significance ($p < 0.05$). Because of these breaks in the emigration rates, I assume that there is a link between a country’s accession to the EU and a change in emigration rate. This is because a country’s membership in the EU makes emigration easier, due to the EU’s FoM.


In sum, accession may not be the only cause, but it certainly brings a new dynamic into the emigration rate over time.
