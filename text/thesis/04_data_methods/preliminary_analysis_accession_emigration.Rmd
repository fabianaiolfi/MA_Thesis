...
```{r accession-emigration-bar, echo=FALSE, fig.height=2, message=FALSE, warning=FALSE, fig.cap="External emigration over time. Dashed line: Year of EU accession (Sources: Statistics Poland, Romanian National Institute of Statistics)"}
