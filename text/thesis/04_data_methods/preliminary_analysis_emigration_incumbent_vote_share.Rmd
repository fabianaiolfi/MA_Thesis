...
model_table %>%
  ...
  add_footnote("Fixed Effects: NUTS regions and years. Standard errors are grouped by NUTS region. Sources: Staffan I. Lindberg et al. 2022, Schraff et al. 2023, Statistics Poland, Romanian National Institute of Statistics", notation = "none")
```
