...
ro_volatility_2012 <- ro_volatility_table %>% 
  ...
  dplyr::rename(`Party ID` = partyfacts_id,
                `Absolute Difference E0 and E1` = diff,
...
kable(ro_volatility_2012,
  ...
  add_footnote("The Pedersen Index is calculated by dividing the sum of the absolute differences by 2. The sum of all absolute differences in RO111 equals 147 and thus has a Pedersen Index of 73.5 in the year 2012. Party identifiers for small parties are missing (Schraff et al. 2023, 572). Full party names can be accessed at partyfacts.herokuapp.com/data/partycodes/Party ID/", notation="none")
```
