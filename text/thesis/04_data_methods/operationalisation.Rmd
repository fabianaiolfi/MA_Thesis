...
ro_volatility_2012 <- ro_volatility_table %>% 
  ...
  dplyr::rename(`Party ID` = partyfacts_id,
                `Vote Share 2008 Election (E0) in %` = y_2008,
                `Vote Share 2012 Election (E1) in %` = y_2012)
...
kable(ro_volatility_2012,
  ...
  kable_styling(font_size = 9) %>% 
  add_footnote("RO111 has a Pedersen Index of 73.5 in the year 2012. Some party identifiers are missing because they are deemed irrelevant by  \\cite{bederkePartyFactsVersion2020} \\citep{schraffEuropeanNUTSlevelElection2023, p. 572}. Full party name can be accessed at partyfacts.herokuapp.com/data/partycodes/Party ID/", notation="none")
```
