...
However, the available data is not this extensives, as displayed in Table X (TO DO: data availability table, must state that PL data is only available at NUTS2 level, and RO data is available at NUTS3 level).

```
Data Availability Table (example data)

Country | Emigration | Election Results     | NUTS              | … ???
