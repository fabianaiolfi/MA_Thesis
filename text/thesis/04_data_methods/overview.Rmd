...
However, the available data are not as extensive as prefered (see Table \@ref(tab:data-availability)). E.g., only NUTS2 level data is available for Poland across all variables. Also, @schraffEuropeanNUTSlevelElection2023 only include one election prior to EU accession. This means that a party’s vote change can only be calculated for post-accession elections.
