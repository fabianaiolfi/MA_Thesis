...
However, the available data are not as extensive as prefered, as displayed in Table X (TO DO: data availability table). TO DO: add description of table.

```
Data Availability Table (example data)

Country | Emigration Data (Source) | Election Results (Source)    | NUTS              | Service Cuts | Control Variables? … ???
PL      | 1998-2019 (2015 missing)  | 2004, 2008, …        | NUTS2: 17 regions
