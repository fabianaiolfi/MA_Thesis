...
Using unique party IDs, I can combine the V-Party Dataset with the European NUTS-level election dataset. This combined dataset shows the regional vote change of incumbent parties and is displayedt in Table \@ref(tab:ned-vdem-sample).
