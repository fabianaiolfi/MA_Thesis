### Research Design
In this thesis I explicitly differentiate between internal emigration, i.e., emigration within a country, and external emigration, i.e., emigration from one country to another. I assume that the EU’s FoM makes emigration between member states easier. Based on this assumption, I focus only on external emigration in order to best isolate the impact of FoM on voting behaviour. I will measure the effects of service cuts on the lowest subnational NUTS level that data are available for. Emigration rates vary in different subnational regions in Poland and Romania (see Figure \@ref(fig:pl-ro-emigration-rate)). Taking these regions into account will account for this variation, with the aim of createing more accurate and stable models.
...
However, the available data is not this extensive, as displayed in Table X (TO DO: data availability table).
