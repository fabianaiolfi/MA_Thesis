...
```{r pl-ro-emigration-rate, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.cap="Yearly external emigration per 1000 inhabitants in a NUTS region (Sources: Statistics Poland, Romanian National Institute of Statistics)"}
