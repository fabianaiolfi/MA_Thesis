...
I set up a two-way fixed effect linear regression model, as this can model data that varies across both regions and time. The Polish models use NUTS2 and Romanian models use NUTS3 regions as well as years as fixed effects. Modelling three institutions seperately and applying three different independent variables results in nine models for each country under examination (see Table \@ref(tab:pl-emigration-service-cuts) for Poland and Table \@ref(tab:ro-emigration-service-cuts) for Romania).
