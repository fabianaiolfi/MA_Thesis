...
```{r pl-ro-population, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="pl-ro-population"}
# NUTS0
...
# demo_r_pjanaggr3_linear_young <- demo_r_pjanaggr3_linear %>% 
#   dplyr::filter(age == "Y_LT15")
# 
# # 65 years or over [Y_GE65]
# demo_r_pjanaggr3_linear_old <- demo_r_pjanaggr3_linear %>% 
#   dplyr::filter(age == "Y_GE65")
# 
# # Total Population
# demo_r_pjanaggr3_linear_total <- demo_r_pjanaggr3_linear %>% 
...
df_plot$age <- factor(df_plot$age, levels = c("Entire Population", "desired_level2", "desired_level3"))  # Replace with your actual level names
...
TO DO:
- Guiding this preliminary examination of a possible association is Figure \@ref(fig:pl-ro-population)
