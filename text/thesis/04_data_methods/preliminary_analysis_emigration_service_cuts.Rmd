...
model_table %>%
  ...
  add_footnote("Fixed Effects: NUTS regions and years. Standard errors are grouped by NUTS region. Source: Statistics Poland", notation = "none")
```
...
model_table %>%
  kable_styling(font_size = 8) %>% 
  add_footnote("Fixed Effects: NUTS regions and years. Standard errors are grouped by NUTS region. Source: Romanian National Institute of Statistics", notation = "none")
```
