...
Despite the hypotheses rejections, we observe that emigration can have a negative effect on incumbent support. Thus incumbent parties in a candidate EU member state should take this into account when going forward with their membership application. Incumbent parties are well advised to prepare for an FoM-induced outflux in order to dampen its impact and minimise its decrease on incumbent support. This can be achieved by implementing policies that incentivise a return after having studied or gathered work experience abroad.

Focusing on school closures, and assuming they are linked to external emigration, a reduction in schools can detrimentally affect the education system. A decrease in school numbers could have serious long-term effects, potentially resulting in a generation receiving substandard education due to FoM-induced emigration. This educational shortfall might negatively impact job prospects, thereby fueling grievances that contribute to Euroscepticism. Therefore, it is in the EU’s interest to address these negative and anti-EU sentiments, ironically arising from a key EU principle, FoM. This issue could be mitigated through EU-level policies aimed at supporting regions affected by emigration, such as investing in education to prevent school closures.
