...
basically: this fundamental aspect of the eu has fundamental consequences for the eu: migration flows do not only affect receiving countries, they also affect sending countries.
...
Sixth, the interaction coefficient results in Table \@ref(tab:results-emigration-incumbent-vote-share-control-interaction) may lack statistical power because many more observations are needed due to noise when using interactions [@gelmanYouNeed162018]. In order to counter this problem, more observations are needed, e.g., data covering a longer time period. In the context of collecting more data, it could be of interest to obtain further electoral data points, as the data provided by @schraffEuropeanNUTSlevelElection2023 only contain one election that occurs before EU accession. CONTINUE HERE This would make understanding the effect of EU accession better.
