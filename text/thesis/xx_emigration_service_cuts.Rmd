...
- Most coefficients are not statistically significant at conventional levels, however some are borderline statistically significant (Number of schools and emigration lagged by 5 year: $p = 0.132$, number of hospitals and emigration lagged by 5 year: $p = 0.24$), thus permitting further research.
