...
```{r external-emigration, fig.height = 6, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Crude emigration per 1000 inhabitants at NUTS3 (Poland: NUTS2; Slovenia: NUTS1) level in all CEE EU member states"}
