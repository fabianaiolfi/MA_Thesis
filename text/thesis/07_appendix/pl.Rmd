...
<!-- Entire Population -->
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Population in millions in Poland at NUTS2 level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Primary school age population in 1000s in Poland at NUTS2 level"}
...
<!-- Emigration Rate -->
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="External emigration per 1000 inhabitants from Poland at NUTS2 level"}
...
<!-- Number of Schools -->
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Number of primary schools in Poland at NUTS2 level"}
...
<!-- Number of Hospitals -->
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Number of hospitals in Poland at NUTS2 level"}
...
```{r echo=FALSE, fig.height = 8, message=FALSE, warning=FALSE, fig.cap="Number of third places in Poland at NUTS2 level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Number of primary school children per school in Poland at NUTS2 level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Number of people per hospital in Poland at NUTS2 level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.cap="Number of people per third place in Poland at NUTS2 level"}
