...
```{r echo=FALSE, fig.height = 8, message=FALSE, warning=FALSE, fig.cap="Primary school age population in 1000s in Romania at NUTS3 level"}
...
<!-- Emigration Rate -->
```{r echo=FALSE, fig.height = 8, message=FALSE, warning=FALSE, fig.cap="External emigration per 1000 inhabitants from Romania at NUTS3 level"}
...
<!-- Number of Hospitals -->
```{r echo=FALSE, fig.height = 8, message=FALSE, warning=FALSE, fig.cap="Number of hospitals in Romania at NUTS3 level"}
...
```{r echo=FALSE, fig.height = 8, message=FALSE, warning=FALSE, fig.cap="Number of third places in Romania at NUTS3 level"}
