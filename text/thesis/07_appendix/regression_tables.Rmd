...
```{r all-results-emigration-incumbent-vote-share, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="All coefficient results of Model Specification A; Dependent Variable: Change in incumbent vote share"}
