...
```{r results-emigration-incumbent-vote-share-control-interaction, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Results of Model Specification B; Dependent Variable: Change in incumbent vote share"}
# new_names <- c(
