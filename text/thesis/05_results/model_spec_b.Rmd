...
When observing the other control variables in all models in Table \@ref(tab:results-emigration-incumbent-vote-share-control-interaction), we see similar coefficients as in Table \@ref(tab:results-emigration-incumbent-vote-share). Again, two of the three control variables display coefficients that align with the theoretical assumptions and are statistically significant across all models. Also, the one control variable that does not align with the theoretical expectation is electoral volatility, as it shows a positive value across all models. This indicates that an increase in volatility is associated with an increase in incumbent vote share change, an unintuitive result.

Because electoral volatility displays unexpected results as a control variable across all models and in both model specifications, this may indicate a mistake in its operationalisation or in the underlaying data. \label{passage:volatility-issue} This issue is discussed in the Conclusion.
