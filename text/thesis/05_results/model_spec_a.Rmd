...
```{r results-emigration-incumbent-vote-share, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Results of Model Specification A; Dependent Variable: Change in incumbent vote share"}
