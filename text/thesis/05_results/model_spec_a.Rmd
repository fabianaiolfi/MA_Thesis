...
Table \@ref(tab:results-emigration-incumbent-vote-share) displays the results of Model Specification A. This models the average change of number of people per institution seperately on incumbent support, while controlling for emigration, volatility, GDP und unemployment while applying NUTS3 regions and years as fixed effects. Models 1 through 4 contain each service cut seperately, while Models 5 and 6 combine all service cuts together, with Model 5 using the number of schools and Model 6 using the classroom proxy to operationalise service cuts to schools. Model 0 does not include any service cuts variables and is included in Table \@ref(tab:results-emigration-incumbent-vote-share) as a reference model.
