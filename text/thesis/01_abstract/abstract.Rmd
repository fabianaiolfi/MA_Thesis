...
- Using two-way fixed effects linear regression models, I examine a possible association between a change in number of people per service, e.g., children per school, and incumbent vote change.
