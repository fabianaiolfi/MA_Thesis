...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of Schools in Poland at NUTS2 Level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of Hospitals in Poland at NUTS2 LevelDO"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of Third Places in Poland at NUTS2 Level"}
