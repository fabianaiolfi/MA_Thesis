...
### External Emigration: Crude Emigration per 1000 Population at NUTS3 Level in all CEE EU Member States
...
```{r external-emigration, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="external-emigration"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Population in Millions in Romania at NUTS3 Level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Primary Age Population in 1000s in Romania at NUTS3 Level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="External Emigration per 1000 Population from Romania at NUTS3 Level"}"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of Primary School Children per School in Romania at NUTS3 Level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of People per Hospital in Romania at NUTS3 Level"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Number of People per Third Place in Romania at NUTS3 Level"}
