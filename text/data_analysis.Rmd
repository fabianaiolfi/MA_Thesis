...
```{r eval=FALSE, child = 'data_analysis/01_introduction.Rmd'}
```

\pagebreak

```{r eval=FALSE, child = 'data_analysis/02_all_cee_eu_ms.Rmd'}
```

\pagebreak

```{r eval=FALSE, child = 'data_analysis/03_pl.Rmd'}
```
...
```{r eval=FALSE, child = 'data_analysis/05_discussion.Rmd'}
```

\pagebreak

```{r eval=FALSE, child = 'data_analysis/06_sources.Rmd'}
```
