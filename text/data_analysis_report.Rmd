...
## Introduction
This document provides an overview of the analysis and results that I have created so far in my MA thesis. It starts with an overview of all eleven CEE EU member states, then dives deeper into the effects of service cuts in Poland.
...
This is an overview of the available external emigration data at NUTS3 level (Poland: NUTS2; Slovenia: NUTS1). Please note that the y-axis is varies by country, the x-axis however is the same for all countries. This makes a comparison of available data across different countries easier. Of the eleven CEE EU member states, only ten are displayed because Czechia does not provide data solely on external emigration.
...
Modelle 1–3: Service Cuts einzeln
...
```
Modelle 4–6: Kombination von Service Cuts - Modell 7: Alle Service Cuts - Ratio Schools ist signifikant und entspricht der Theorie: Je mehr Emigration, desto schlechter schneiden die Parteien an der Macht ab.
